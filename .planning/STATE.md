...
Phase 2 implementation and local verification complete; updating the existing draft PR.
...
- Keep draft PR #1; no merge/production replacement without user direction.
